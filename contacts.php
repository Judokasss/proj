...
if (isset($_POST['editor'])) {
    $sql = ("UPDATE product SET `product_name` = ?, `product_price` = ?, `product_image` = ?, `product_images` = ?, `description` = ? WHERE `id` = ? ");
...
if (isset($_POST['addtocart'])) {
    ...
    if (in_array($avatar_ext, $allowed_exts) && $avatar_error === 0 && $avatar_size <= 5242880) { // validate avatar file
        ...
        $sql = "INSERT INTO product (product_name, product_image, product_price, product_images, description) VALUES (?, ?, ?, ?, ?)";
        $query = $dbh->prepare($sql);
                        ...
                        <div class="container1">
                            <div class="wrapper">
                                <div class="banner-image">
                                    ...
                                    <img style="width:270px; height:300px;" src="<?= $product['product_image'] ?>" alt="">
                                </div>
                                <p><br /></p>
                            </div>
